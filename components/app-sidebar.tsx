...
const NAV_MAIN = [
  ...
  { title: "PM Maintenance Schedule",  url: "/dashboard/pm-maintenance-schedule", icon: CalendarCheck },
...
function SearchModal({ onClose }: { onClose: () => void }) {
  ...
  const ALL_PAGES = [
    ...
    { title: "PM Maintenance Schedule", url: "/dashboard/pm-maintenance-schedule", icon: CalendarCheck, desc: "Perencanaan & dispatch kunjungan preventive maintenance per site" },
